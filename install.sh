...
INSTALLER_VERSION="install-v1.0.20"
ENGINE_BUNDLE_TAG="dawsos-bundle-v1-69c16a8"
ENGINE_ASSET="dawsos-engine-69c16a8.tar.gz"
ENGINE_SHA256_ASSET="dawsos-engine-69c16a8.tar.gz.sha256"
