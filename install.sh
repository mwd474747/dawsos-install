...
INSTALLER_VERSION="install-v1.0.30"
ENGINE_BUNDLE_TAG="dawsos-bundle-v1-82c3087"
ENGINE_ASSET="dawsos-engine-82c3087.tar.gz"
ENGINE_SHA256_ASSET="dawsos-engine-82c3087.tar.gz.sha256"
