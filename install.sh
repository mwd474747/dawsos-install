...
INSTALLER_VERSION="install-v1.0.13"
ENGINE_BUNDLE_TAG="dawsos-bundle-v1-9205637"
ENGINE_ASSET="dawsos-engine-9205637.tar.gz"
ENGINE_SHA256_ASSET="dawsos-engine-9205637.tar.gz.sha256"
