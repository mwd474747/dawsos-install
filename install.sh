...
INSTALLER_VERSION="install-v1.0.36"
ENGINE_BUNDLE_TAG="dawsos-bundle-v1-14ae929"
ENGINE_ASSET="dawsos-engine-14ae929.tar.gz"
ENGINE_SHA256_ASSET="dawsos-engine-14ae929.tar.gz.sha256"
