...
INSTALLER_VERSION="install-v1.0.38"
ENGINE_BUNDLE_TAG="dawsos-bundle-v1-f0c137b"
ENGINE_ASSET="dawsos-engine-f0c137b.tar.gz"
ENGINE_SHA256_ASSET="dawsos-engine-f0c137b.tar.gz.sha256"
