...
INSTALLER_VERSION="install-v1.0.12"
ENGINE_BUNDLE_TAG="dawsos-bundle-v1-5c93946"
ENGINE_ASSET="dawsos-engine-5c93946.tar.gz"
ENGINE_SHA256_ASSET="dawsos-engine-5c93946.tar.gz.sha256"
