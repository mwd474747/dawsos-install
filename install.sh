...
INSTALLER_VERSION="install-v1.0.32"
ENGINE_BUNDLE_TAG="dawsos-bundle-v1-4066331"
ENGINE_ASSET="dawsos-engine-4066331.tar.gz"
ENGINE_SHA256_ASSET="dawsos-engine-4066331.tar.gz.sha256"
