...
INSTALLER_VERSION="install-v1.0.14"
ENGINE_BUNDLE_TAG="dawsos-bundle-v1-043604f"
ENGINE_ASSET="dawsos-engine-043604f.tar.gz"
ENGINE_SHA256_ASSET="dawsos-engine-043604f.tar.gz.sha256"
