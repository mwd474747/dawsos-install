...
INSTALLER_VERSION="install-v1.0.41"
ENGINE_BUNDLE_TAG="dawsos-bundle-src-20260308-021653Z"
ENGINE_ASSET="dawsos-engine-1a924b6.tar.gz"
ENGINE_SHA256_ASSET="dawsos-engine-1a924b6.tar.gz.sha256"
