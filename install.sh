...
INSTALLER_VERSION="install-v1.0.42"
ENGINE_BUNDLE_TAG="dawsos-bundle-src-20260308-022110Z"
ENGINE_ASSET="dawsos-engine-5efa754.tar.gz"
ENGINE_SHA256_ASSET="dawsos-engine-5efa754.tar.gz.sha256"
