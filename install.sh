...
INSTALLER_VERSION="install-v1.0.37"
ENGINE_BUNDLE_TAG="dawsos-bundle-v1-450d6cb"
ENGINE_ASSET="dawsos-engine-450d6cb.tar.gz"
ENGINE_SHA256_ASSET="dawsos-engine-450d6cb.tar.gz.sha256"
