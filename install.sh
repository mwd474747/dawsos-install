...
INSTALLER_VERSION="install-v1.0.8"
ENGINE_BUNDLE_TAG="dawsos-bundle-v1-54365a2"
ENGINE_ASSET="dawsos-engine-54365a2.tar.gz"
ENGINE_SHA256_ASSET="dawsos-engine-54365a2.tar.gz.sha256"
