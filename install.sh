...
INSTALLER_VERSION="install-v1.0.21"
ENGINE_BUNDLE_TAG="dawsos-bundle-v1-d5d4dc6"
ENGINE_ASSET="dawsos-engine-d5d4dc6.tar.gz"
ENGINE_SHA256_ASSET="dawsos-engine-d5d4dc6.tar.gz.sha256"
