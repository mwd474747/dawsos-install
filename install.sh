...
INSTALLER_VERSION="install-v1.0.18"
ENGINE_BUNDLE_TAG="dawsos-bundle-v1-ad2cfc9"
ENGINE_ASSET="dawsos-engine-ad2cfc9.tar.gz"
ENGINE_SHA256_ASSET="dawsos-engine-ad2cfc9.tar.gz.sha256"
