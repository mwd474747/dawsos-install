...
INSTALLER_VERSION="install-v1.0.11"
ENGINE_BUNDLE_TAG="dawsos-bundle-v1-28f8358"
ENGINE_ASSET="dawsos-engine-28f8358.tar.gz"
ENGINE_SHA256_ASSET="dawsos-engine-28f8358.tar.gz.sha256"
