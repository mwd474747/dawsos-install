...
INSTALLER_VERSION="install-v1.0.45"
ENGINE_BUNDLE_TAG="dawsos-bundle-src-20260308-024322Z"
ENGINE_ASSET="dawsos-engine-5eaf8a3.tar.gz"
ENGINE_SHA256_ASSET="dawsos-engine-5eaf8a3.tar.gz.sha256"
