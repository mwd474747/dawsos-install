...
INSTALLER_VERSION="install-v1.0.31"
ENGINE_BUNDLE_TAG="dawsos-bundle-v1-6ae0922"
ENGINE_ASSET="dawsos-engine-6ae0922.tar.gz"
ENGINE_SHA256_ASSET="dawsos-engine-6ae0922.tar.gz.sha256"
