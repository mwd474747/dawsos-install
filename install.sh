...
INSTALLER_VERSION="install-v1.0.15"
ENGINE_BUNDLE_TAG="dawsos-bundle-v1-ffad501"
ENGINE_ASSET="dawsos-engine-ffad501.tar.gz"
ENGINE_SHA256_ASSET="dawsos-engine-ffad501.tar.gz.sha256"
