...
INSTALLER_VERSION="install-v1.0.35"
ENGINE_BUNDLE_TAG="dawsos-bundle-v1-ffcd944"
ENGINE_ASSET="dawsos-engine-ffcd944.tar.gz"
ENGINE_SHA256_ASSET="dawsos-engine-ffcd944.tar.gz.sha256"
