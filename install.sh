...
INSTALLER_VERSION="install-v1.0.19"
ENGINE_BUNDLE_TAG="dawsos-bundle-v1-bd3f6b2"
ENGINE_ASSET="dawsos-engine-bd3f6b2.tar.gz"
ENGINE_SHA256_ASSET="dawsos-engine-bd3f6b2.tar.gz.sha256"
