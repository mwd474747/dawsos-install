...
curl -fsSL https://raw.githubusercontent.com/mwd474747/dawsos-install/install-v1.0.4/install.sh | bash
```
...
Dry-run (diagnostic):
```bash
curl -fsSL https://raw.githubusercontent.com/mwd474747/dawsos-install/install-v1.0.4/install.sh | bash -s -- --dry-run
```
